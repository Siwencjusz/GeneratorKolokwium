...
namespace generatorKolokwiumZZakresuTeoriiLiczb.Exercises.ex9
{
    ...
    public class Exercise9 : IExercise
    {
        ...
        {
            return "Zadanie 9" + Environment.NewLine +"phi="+Phi+ " n=" + N + " p=" + P + " q=" + Q + " r=" + R + Environment.NewLine;
        ...
        {
            var XML = "\\item Wyznaczyć wartość funkcji Eulera $\\varphi$(" + N + ")" + Environment.NewLine;
                return XML;
        }
    }
}
